...
for embedding in models:
    ...
    kmeans = KMeans(n_clusters=3,random_state=0).fit(embedding.get_embedding())
    ...
    # print("DEBUG::reduced embedding vectors:")
    # print(X_)
    ...
    plt.title('Community Detection using GEMs on Graph of Political Blogs')
    plt.show()

    edge_out = edge_f+".OUT"
    nx.write_edgelist(G,edge_out,data=False)